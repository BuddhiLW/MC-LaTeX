    ...
    \begin{figure}[!bth]
      ...
      \begin{center}
        ...
        \begin{ganttchart}[
          ...
          \ganttbar[bar/.style={draw=black, outer
            color=orange!50, inner
            color=orange!50}]{{\large{\textbf{Aula 1 (Youtube)}}}}{4}{8}\\
         ...
         %%%%%%%%%%%%%   SEGUNDA AULA %%%%%%%%%%%%%%%
          \ganttgroup{\large{Material 2}}{8}{17} \\
          \ganttbar[bar/.style={draw=black, outer
            color=orange!50, inner
            color=orange!50}]{{\large{\textbf{Aula 2 (YT)}}}}{8}{12}\\

          \ganttbar[bar/.style={draw=black, outer
            color=green!50, inner color=green!35}]{{Dúvidas (Meet)
              1}}{14}{16}
          \ganttbar[bar/.style={draw=black, outer
            color=green!50, inner color=green!35}]{}{14}{16}\\
          ...
          %%%%%%%%%%%%% TERCEIRA AULA %%%%%%%%%%%%%%%
          \ganttgroup{\large{Material 3}}{14}{23} \\
          \ganttbar[bar/.style={draw=black, outer
            color=orange!50, inner
            color=orange!50}]{{\large{\textbf{Aula 3 (YT)}}
            }}{14}{18}\\
