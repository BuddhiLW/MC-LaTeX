    ...
    \begin{figure}[!bth]
      ...
      \begin{center}
        ...
        \begin{ganttchart}[
          ...
          \ganttbar[bar/.style={draw=black, outer
            color=red!70, inner color=red!60}]{{Inscri̤̣o}}{0}{4}
    ...
    \begin{figure}[!bth]
      ...
      \begin{center}
        ...
        \begin{ganttchart}[
          ...
          {1}{40}
          \gantttitle[title/.style={draw=black,
            fill=white}]{\LARGE{\textbf{\fontfamily{put}\selectfont Setembro-Junho}}}{40} \\
          ...
          \gantttitle{Maio}{4}{8} \gantttitle{Junho}{4}{8}\\
          \gantttitlelist{1,...,10}{4} \\[grid]
          ...
          \ganttgroup[group/.style={draw=black, outer
            color=branqs1, inner
            color=branqs2!50}]{{\textsc{{Completo}}}}{0}{39} \\

          \ganttgroup[group/.style={draw=black, outer
            color=branqs1!10, inner
            color=branqs2!50}]{{\textsc{{Andamento}}}}{39}{40} \\

          \ganttbar[bar/.style={draw=black, outer
            color=red!70, inner color=red!60}]{Quarentena}{24}{40}\\
          ...
          \ganttbar[bar/.style={draw=black!80, outer
            color=black!80, inner color=black!70}]{}{38}{40}\\
